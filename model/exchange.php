...
class exchange {
    ...
    public function __construct($url = "http://www.ecb.int/stats/eurofxref/eurofxref-daily.xml") {
        ...
        $this->exchrate["EUR"] = 1;
        $this->exchrate["USD"] = 1.12;
        $this->exchrate["GBP"] = 0.86;
        $this->exchrate["CAD"] = 1.5;
        $this->exchrate["CNY"] = 7.5;
        $this->exchrate["HKD"] = 8.75;
        $this->exchrate["AUD"] = 1.58;
        $this->exchrate["SGD"] = 1.52;
        $this->exchrate["INR"] = 77.89;
