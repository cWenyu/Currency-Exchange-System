...
if ($action == 'list_currencies') {
    ...
    include('view/admin_view/currency_list.php');
}
...
//new register 
    ...
    include ("view/admin_view/user_add.php");
...
//user account cancellation
    ...
    include ("view/admin_view/user_cancellation.php");
...
//buy product
    ...
    $currencies = get_currencies();
    include ("view/index_view/admin_view/user_buy_currency.php");
    ...
    if ($quantity == NULL) {
        ...
        include 'view/admin_view/user_production.php';
    }
}
?>