<!-- reference:  http://www.abrandao.com/2013/04/php-currency-converter-exchange-rates/ -->
...
<form action="#" method="post" name="formx">
  <fieldset>
      <div class="container">
          ...
          <div >
  <h1 align="center"> Currency and Exchange Rates </h1></div>
  <table border="0" cellspacing="2" cellpadding="2" class="table table-striped">
   <tbody class="tbody">
    <tr>
      <td width="137" style="text-align:right"><?php 
    ...
    <tr>
      <td style="text-align:right"><?php 	$from="EUR"; $to="GBP"; $amt=1; ?>
        €
    ...
    <tr>
      <td style="text-align:right"><?php 	$from="EUR"; $to="CAD"; $amt=1;    ?>
        €
    ...
    <tr>
      <td style="text-align:right"><?php 	$from="EUR"; $to="HKD"; $amt=1;    ?>
        €
    ...
    <tr>
      <td style="text-align:right"><?php 	$from="EUR"; $to="AUD"; $amt=1;    ?>
        €
    ...
    <tr>
      <td style="text-align:right"><?php 	$from="EUR"; $to="SGD"; $amt=1;    ?>
        €
    ...
    <tr>
      <td style="text-align:right"><?php 	$from="EUR"; $to="CNY"; $amt=1;    ?>
        €
    ...
    <tr>
      <td style="text-align:right"><?php 	$from="EUR"; $to="INR"; $amt=1;    ?>
        €
